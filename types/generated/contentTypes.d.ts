...
export interface ApiParentParent extends Schema.CollectionType {
  ...
  attributes: {
    ...
    password: Attribute.Password;
    publishedAt: Attribute.DateTime;
    role: Attribute.Enumeration<['parent']>;
    updatedAt: Attribute.DateTime;
    updatedBy: Attribute.Relation<
      'api::parent.parent',
      'oneToOne',
...
export interface ApiProductProduct extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    curso: Attribute.Enumeration<['Primero BGU', 'Segundo BGU', 'Tercero BGU']>;
    Description: Attribute.Text;
    images: Attribute.Media<'images' | 'files' | 'videos' | 'audios', true>;
    isFeatured: Attribute.Boolean;
    materia: Attribute.Enumeration<
      [
        'Ingl\u00E9s',
        'Lengua y Literatura',
        'Matem\u00E1ticas',
...
export interface ApiReservaReserva extends Schema.CollectionType {
  ...
  attributes: {
    ...
    > &
      Attribute.Private;
    estado: Attribute.Enumeration<['Pendiente', 'Confirmado', 'Cancelado']> &
      Attribute.DefaultTo<'Pendiente'>;
    fechaReserva: Attribute.Date;
